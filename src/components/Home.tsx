              ...
              <div className="tab-category-slider">
                ...
                <div className="title_block_ul">
                  <ul className="tab_cates">
                    <li rel="tab_14" className="active">
                      Living room
                    </li>
                        ...
                        <div className="item">
                          <div className="item-inner">
                            ...
                            >
                              <div className="left-product">
                                <a
                                  href="https://demo.fieldthemes.com/decor/home3/en/categories/5-19-printed-summer-dress.html#/1-size-s/16-color-yellow"
                          ...
                          <div className="item-inner">
                            ...
                            >
                              <div className="left-product">
                                <a
                                  href="https://demo.fieldthemes.com/decor/home3/en/home/6-31-printed-summer-dress.html#/1-size-s/16-color-yellow"
                                  className="thumbnail product-thumbnail"
                                >
                                  <span className="cover_image">
                                    <img
                        ...
                        <div className="item">
                          <div className="item-inner">
                            ...
                            >
                              <div className="left-product">
                                <a
                                  href="https://demo.fieldthemes.com/decor/home3/en/categories/8-51-faded-short-sleeves-tshirt.html#/1-size-s/13-color-orange"
                                  className="thumbnail product-thumbnail"
                                >
                                  <span className="cover_image">
                                    <img
                  ...
                  <div className="col-xs-12 col-sm-6 block">
                    <div className="row">
                      <div className="col-xs-12 col-sm-12 col-md-12">
                        <div className="banner-text1">
                          <h3>
                            <a href="#">Classic Desk Lamp</a>
                          </h3>
                          <p>
                            Curabitur sit amet enim sodales nisl efficitur
                            porttitor. Donec ac turpis diam. Mauris interdum
                            magna eu neque convallis.
                          </p>
                          <a className="title_font shop-now1" href="#">
                            Shop now !
                          </a>
